...
export const myProjects = [
  {
    ...
    logoStyle: {
      ...
      boxShadow: '0px 0px 30px 0px #3A6D9F',
    },
    features: `
      User Authentication (Login/Signup) using JWT and bcrypt.
      Profile Upload with Multer and Cloudinary.
      Real-Time Messaging powered by Socket.io.
      Online Users Display with dynamic real-time updates.
      Media Sharing of images and videos in chat.
      Clean and Responsive UI with React.js and Redux Toolkit.
    `,
    
   
    tags: [
      { id: 1, name: 'Node.js', path: '/assets/NodeJs.png' },
      { id: 2, name: 'Express.js', path: '/assets/ExpressJs.png' },
      { id: 3, name: 'MongoDB', path: '/assets/MongoDB.png' },
      { id: 4, name: 'Socket.io', path: '/assets/Socket-io.svg' },
      { id: 5, name: 'React.js', path: '/assets/react.svg' },
    ],
  },

  {
    ...
    tags: [
      { id: 1, name: 'Express', path: '/assets/ExpressJs.png' },
      { id: 2, name: 'React.js', path: '/assets/react.svg' },
      { id: 3, name: 'Node.js', path: '/assets/NodeJs.png' },
      { id: 4, name: 'Socket.io', path: '/assets/Socket-io.svg' },
      { id: 5, name: 'TypeScript', path: '/assets/TypeScript.jpeg' },
    ],
    editTool: {
...

  {
    ...
    tags: [
      ...
      { id: 3, name: 'Express.js', path: '/assets/ExpressJs.png' },
      { id: 4, name: 'MongoDB', path: '/assets/MongoDB.png' },
      { id: 5, name: 'Socket.io', path: '/assets/Socket-io.svg' },
      { id: 6, name: 'Google Maps', path: '/assets/google.jpeg' },
    ],
  },
];
